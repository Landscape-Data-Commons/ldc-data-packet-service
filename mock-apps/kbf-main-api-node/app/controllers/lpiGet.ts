...
export const getLPI = (req:Request, res:Response) =>{
...
export const getLPICoords = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getLPICoords_public = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getLPICoords_loggedrestricted = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getLPICoords_loggedrestricted_datelimited = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getLPICoords_loggedrestricted_lmflimited = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
