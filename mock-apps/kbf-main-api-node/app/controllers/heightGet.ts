...
export const getHeight= (req:Request, res:Response) =>{
...
export const getHeightCoords = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getHeightCoords_public = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getHeightCoords_loggedrestricted = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getHeightCoords_loggedrestricted_lmflimited= (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getHeightCoords_loggedrestricted_datelimited= (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
