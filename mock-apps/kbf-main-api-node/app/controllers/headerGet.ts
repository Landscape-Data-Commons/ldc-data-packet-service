...
export const getHeader= (req:Request, res:Response) =>{
...
export const getHeaderCoords = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getHeaderCoords_public = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
...
export const getHeaderCoords_loggedrestricted = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
  for(const [key,value] of Object.entries(req.query)){
    ...
    console.log(usefulCoords)
    let pre = pairUp(usefulCoords)
    let finalcoords = `header_json_nopermissions('${coordPair(pre)}')`
    sql = sql + finalcoords
    console.log(sql)
...
export const getHeaderCoords_loggedrestricted_lmflimited = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
  for(const [key,value] of Object.entries(req.query)){
    ...
    console.log(usefulCoords)
    let pre = pairUp(usefulCoords)
    let finalcoords = `header_json_lmflimited('${coordPair(pre)}')`
    sql = sql + finalcoords
    console.log(sql)
...
export const getHeaderCoords_loggedrestricted_datelimited = (req:Request, res:Response) =>{
  let sql = `
    SELECT * 
      FROM 
    `
  for(const [key,value] of Object.entries(req.query)){
    ...
    console.log(usefulCoords)
    let pre = pairUp(usefulCoords)
    let finalcoords = `header_json_datelimited('${coordPair(pre)}')`
    sql = sql + finalcoords
    console.log(sql)
