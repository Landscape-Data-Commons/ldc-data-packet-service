...
exports.selectorQueryParameters = exports.indicatorQueryParameters = exports.ecologicalSiteSelectors = exports.ecoregionSelectors = exports.filterQueryParametersToColumns = void 0;
/* 2022-02-15-CMF:
  Usage:
    ./queries.ts
      QueryGenerator.getSelectorWhereConditions()
*/
exports.filterQueryParametersToColumns = {
...
/* 2022-02-15-CMF:
  Usage:
    ./queries.ts
      QueryGenerator.getSelectorWhereConditions()
*/
exports.ecologicalSiteSelectors = [
    'ecologicalSiteId',
...
*/
exports.indicatorQueryParameters = [
    'percentBareGround',
    'percentFoliarCover',
    'percentLitterCover',
...
*/
exports.selectorQueryParameters = [
    'landCoverName',
    'ecoregionLevelI',
    'ecoregionLevelII',
    'ecoregionLevelIII',
