...
import extractColumnDescriptions from '../parse/query-processor.js'
...
async function generateMetadataXmlFile(tableName: any, columnNameDescriptionStrings: any) {
...
// process.exit()
*/
export default generateMetadataXmlFiles